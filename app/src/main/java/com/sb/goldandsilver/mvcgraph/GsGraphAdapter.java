package com.sb.goldandsilver.mvcgraph;
...
import com.sb.goldandsilver.query.QueryContract;
...
public class GsGraphAdapter extends BaseExpandableListAdapter {
    ...
    public GsGraphAdapter(List<String> grList, List<Object> childItem) {
        mGroupItem = grList;
